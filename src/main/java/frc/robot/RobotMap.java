...
public class RobotMap 
{
  ...
  // Servos
  // =============================
  public static final int SHOOTER_SLIDER_ROTARY_SERVO_PWM_PORT = 9;

  //==============================
  //Victor Motor Controllers
  //==============================
  public static final int INFEED_MOTOR_RIGHT_PWM_PORT = 8;
  public static final int INFEED_MOTOR_LEFT_PWM_PORT = 7;
